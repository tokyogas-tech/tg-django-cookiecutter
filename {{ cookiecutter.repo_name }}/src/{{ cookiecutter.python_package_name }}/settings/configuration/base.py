...
ROOT_URLCONF = f"{{ cookiecutter.python_package_name }}.interface.urls"
...
STATICFILES_DIRS = (
    normpath(join(SITE_ROOT, "interface/static")),
)
...
TEMPLATES = [
    {
        ...
        "DIRS": [
            normpath(join(SITE_ROOT, "interface/templates")),
        ],
        "OPTIONS": {
            "context_processors": [
...
LOCAL_APPS = (
    "{{ cookiecutter.python_package_name }}.interface.accounts.Config",
    "{{ cookiecutter.python_package_name }}.interface.authentication.Config",
)
